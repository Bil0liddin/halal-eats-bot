...
PLANS = [
    ...
    dict(
        ...
        name_en="Monthly plan (22 working days)",
...
MENU_ITEMS = [
    dict(
        ...
        description_en="Uzbekistan's national rice dish, cooked with beef, carrots and onion",
    ...
    dict(
        ...
        description_en="Steamed dumplings filled with minced meat",
        category=MealCategory.MAIN,
        contains_beef=True,
        calories=450,
    ...
    dict(
        ...
        description_en="Hand-pulled noodles stir-fried with beef and vegetables",
        category=MealCategory.MAIN,
        contains_beef=True,
        calories=550,
    ...
    dict(
        ...
        description_en="Beef skewers grilled over charcoal",
        category=MealCategory.MAIN,
        contains_beef=True,
        calories=500,
        allergens="",
    ...
    dict(
        ...
        description_en="Small meat dumplings served in hot broth",
    ...
    dict(
        ...
        description_en="Flaky pastry filled with minced meat, baked in a tandoor",
        category=MealCategory.MAIN,
        contains_beef=True,
        calories=480,
        allergens="Bug'doy (gluten)",
